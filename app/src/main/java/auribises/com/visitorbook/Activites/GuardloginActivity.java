...
public class GuardloginActivity extends AppCompatActivity implements View.OnClickListener{
        ...
        if (id==R.id.button){
            if(validate()) {
                if (isNetworkConected())
                    login();
                Intent i = new Intent(GuardloginActivity.this, GuardhomeActivity.class);
                startActivity(i);
            }else
        ...
        StringRequest request=new StringRequest(Request.Method.POST, Util.LOGIN_PHP, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(i==1){
                    ...
                    Intent intent = new Intent(GuardloginActivity.this, GuardloginActivity.class);
